...
-- ======================================================
-- NO se ejecuta automáticamente en producción. Es equivalente al seeding que hoy
-- hace src/components/FirebaseSync.tsx (INITIAL_PRODUCTS, INITIAL_INVENTORY,
-- INITIAL_STAFF, INITIAL_ORDERS, INITIAL_INGREDIENTS, INITIAL_CLIENTS), fusionando
-- 'inventory' e 'ingredients' (duplicados en Firestore) en la tabla INGREDIENTE única.
--
...
-- ------------------------------------------------------
INSERT INTO ADMINISTRADOR (id_admin, nombre, correo, telefono, contrasena, nivel_acceso, creado_por) VALUES
...
SET @id_programador = (SELECT id_admin FROM ADMINISTRADOR WHERE correo = 'programador@copiway.com');
...
SET @id_admin = (SELECT id_admin FROM ADMINISTRADOR WHERE correo = 'admin@copiway.com');

INSERT INTO AYUDANTE_COCINA (id_ayudante, nombre, correo, telefono, contrasena, turno, creado_por) VALUES
...
INSERT INTO DOMICILIARIO (id_domiciliario, nombre, correo, telefono, contrasena, tipo_vehiculo, base_efectivo_asignada, creado_por) VALUES
...
INSERT INTO CLIENTE (id_cliente, nombre, telefono, correo, contrasena, direccion, fecha_nacimiento, puntos_fidelidad, total_gastado, fecha_aceptacion_habeas_data, ip_aceptacion_habeas_data) VALUES
...
-- ------------------------------------------------------
INSERT INTO INGREDIENTE (id_ingrediente, id_categoria, nombre, unidad_medida, cantidad_stock, umbral_minimo, costo_unitario, precio_extra, proveedor) VALUES
...
-- Productos + receta
-- ------------------------------------------------------
INSERT INTO PRODUCTO (id_producto, id_categoria, nombre, descripcion, precio, imagen, etiqueta_destacada) VALUES
...
INSERT INTO RECETA (id_receta, id_producto, id_ingrediente, cantidad_necesaria)
...
INSERT INTO PEDIDO (id_pedido, id_cliente, id_domiciliario, direccion_entrega, estado, metodo_pago, estado_pago, fecha_pago, subtotal, costo_domicilio, total, puntos_ganados) VALUES
('', @cli1, @dom1, 'Cra 51B # 82-254, Apto 301', 'en_camino', 'digital', 'aprobado', NOW(), 30000, 5000, 35000, 35);
SET @ped1 = (SELECT id_pedido FROM PEDIDO ORDER BY numero_pedido DESC LIMIT 1);
INSERT INTO DETALLE_PEDIDO (id_detalle, id_pedido, id_producto, nombre_producto, cantidad, precio_unitario) VALUES
('', @ped1, @prod_clasica, 'Hamburguesa Clásica Copiway', 2, 12000);

INSERT INTO PEDIDO (id_pedido, id_cliente, id_ayudante, direccion_entrega, estado, metodo_pago, estado_pago, subtotal, costo_domicilio, total) VALUES
('', @cli2, @ayu1, 'Calle 84 # 46-20, Local 2', 'en_preparacion', 'efectivo', 'pendiente', 14000, 5000, 19000);
SET @ped2 = (SELECT id_pedido FROM PEDIDO ORDER BY numero_pedido DESC LIMIT 1);
INSERT INTO DETALLE_PEDIDO (id_detalle, id_pedido, id_producto, nombre_producto, cantidad, precio_unitario) VALUES
('', @ped2, @prod_clasica, 'Hamburguesa Clásica Copiway', 1, 14000);

INSERT INTO PEDIDO (id_pedido, id_cliente, id_domiciliario, direccion_entrega, estado, metodo_pago, estado_pago, fecha_pago, fecha_hora, subtotal, costo_domicilio, total, puntos_ganados) VALUES
('', @cli1, @dom1, 'Cra 51B # 82-254, Apto 301', 'entregado', 'digital', 'aprobado', NOW() - INTERVAL 1 DAY, NOW() - INTERVAL 1 DAY, 20000, 5000, 25000, 25);
SET @ped3 = (SELECT id_pedido FROM PEDIDO ORDER BY numero_pedido DESC LIMIT 1);
INSERT INTO DETALLE_PEDIDO (id_detalle, id_pedido, id_producto, nombre_producto, cantidad, precio_unitario) VALUES
('', @ped3, @prod_clasica, 'Hamburguesa Clásica Copiway', 1, 14000),
('', @ped3, @prod_papas, 'Papas Fritas', 1, 6000);
INSERT INTO RESENA (id_resena, id_pedido, puntaje, comentario) VALUES
